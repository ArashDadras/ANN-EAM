// ANN-LBA with sigmoid mapping function for drifts without asymptote modulation,
...
transformed parameters {
	...
	for (n in 1:N) {
        ...
        drift_word_t[n] = theta_1_sbj[participant[n]] / (1 + exp(-alpha_sbj[participant[n]] * (p[n][1]-0.5)));
