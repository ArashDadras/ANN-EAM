...
parameters {
    real<lower=0> threshold_nonword;
}
...
model {
    ...
    RT ~ race(ndt, threshold_word, threshold_t_nonword, drift_word_t, drift_nonword_t);
}
...
generated quantities {
    ...
    {
        for (n in 1:N){
            log_lik[n] = race_lpdf(block(RT, n, 1, 1, 2)| segment(ndt, n, 1), segment(threshold_word, n, 1),
